 ...
 */
public class Kitten extends ViewGroup {
    ...
    public Kitten(Context context) {
        this(context, null);
    }

    public Kitten(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Kitten(Context context, AttributeSet attrs, int defStyle) {
